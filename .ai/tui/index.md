...
This index tracks all TUI-related sprints for the Bubble Tea interactive terminal interface.
...
|-------------|----------------------|--------------------------------------------------------------------------|
| sprint-002d | TUI Architecture     | [sprint-002d/task.md](sprint-002d/task.md)                               |
