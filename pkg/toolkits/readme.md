...
| [TUI](tui/readme.md) | Bubble Tea list/detail state, layout, forms, dialogs, and key names | `main/tui`, `app/surfaces/tui`, and TUI domain view models |
...
rules in the domain module, Mixology-wide conventions in `app/surfaces/<surface>` when such a layer
exists, and framework mechanics here only after more than one adapter needs them.
