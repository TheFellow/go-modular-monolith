...
func (m *Module) Update(ctx *middleware.Context, menu *models.Menu, edits ...tag.Edit) (*models.Menu, error) {
	return m.pipeline.LoadCommand(ctx, authz.ActionUpdate,
		...
		withTags(edits, func(ctx *middleware.Context, _ *models.Menu) (*models.Menu, error) {
