...
func (m *Module) Update(ctx *middleware.Context, drink *models.Drink, edits ...tag.Edit) (*models.Drink, error) {
	...
	return m.pipeline.LoadCommand(ctx, authz.ActionUpdate,
		...
		withTags(edits, func(ctx *middleware.Context, _ *models.Drink) (*models.Drink, error) {
