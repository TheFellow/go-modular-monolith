...
func (m *Module) AddDrink(ctx *middleware.Context, menuID cedar.EntityUID, drinkID cedar.EntityUID) (models.Menu, error) {
	...
	return middleware.RunCommand(ctx, authz.ActionAddDrink, resource, func(mctx *middleware.Context, _ struct{}) (models.Menu, error) {
		return m.commands.AddDrink(mctx, menuID, drinkID)
	}, struct{}{})
}
